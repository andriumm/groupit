...
export default function TopicPage({ onUpdateSubtopic }) {
  ...
  return (
    <div>
      <h2 className="text-uppercase d-flex">{topic.topic_name}</h2>
      ...
      <div className="dashboardBox" >
        {subtopics.map((subtopic) => (
          <div className="perTopicBoxDiv" key={subtopic.id}>
            ...
            <div id="perTopicBox d-flex">

            <h5
                className="titlePerTopic text-uppercase d-flex" 
              ...
              <button
                className="deleteButtonPerTopic btn d-flex"
